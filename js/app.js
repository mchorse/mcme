...
var props = [
    "parent", "holding", "swiping", "looking", "swinging", 
...
Model.prototype = 
{
    ...
    add: function(parent)
    {
        var limb = this.model.add(parent);
        
        var mesh = this.buildLimb(limb);
        this.mapUV(mesh);
...
Properties.prototype = 
{
    ...
    change: function(input)
    {
        ...
        var keys = name.split("_");
            key  = keys.shift() + "Change";
        
        this[key] ? this[key](limb, value, name) : (limb[key] = value);
    },
...
utils.extend(ModelSettings, Settings, 
{
    ...
    importModel: function()
    {
        ...
        reader.onload = function (e) {
            ...
            self.editor.actor.importJSON(e.target.result);
...
utils.extend(TextureSettings, Settings, 
{
    ...
    resize: function()
    {
        this.editor.app.skin.resize(+this.settings.size_w, +this.settings.size_h);
        this.editor.reset();
    },
