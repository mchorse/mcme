...
clearInterval(this.timer),this.timer=setInterval(function(){t.app.model.update()},100)},reset:function(){var t=this.canvas,e=8*this.app.skin.w,i=8*this.app.skin.h
