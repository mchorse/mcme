...
return this.limbs.push(i),this.poses.formLimb(i),i.parent=t||"",i},remove:function(t){var i=this.limbs.indexOf(t),e=this
...
a.prototype={add:function(t){var i=this.model.add(t?t.limb.id:""),e=this.buildLimb(i)
...
t=t.replace(/\n\s+(?=-?\d|\])/g,""),window.open("data:text/json,"+encodeURI(t))},importAction:function(){this.file.value=null,this.file.click()},importModel:function(){var t=new FileReader,i=this
