...
var i=t/128,s=e/128
this.perspec.aspect=t/e,this.ortho.left=-i,this.ortho.right=i,this.ortho.top=s,this.ortho.bottom=-s,this.perspec.updateProjectionMatrix(),this.ortho.updateProjectionMatrix()}}},{}],12:[function(t,e,i){e.exports={scheme:"1.3",name:"Steve",texture:[64,32],poses:{standing:{size:[1,2,1],limbs:{head:{translate:[0,24,0],rotate:[0,0,0]},outer:{translate:[0,4,0],scale:[1.1,1.1,1.1]},body:{translate:[0,24,0]},left_arm:{translate:[6,24,0]},right_arm:{translate:[-6,24,0]},left_leg:{translate:[2,12,0]},right_leg:{translate:[-2,12,0]}}},sneaking:{size:[1,1.5,1]},sleeping:{size:[1,1,2]},flying:{size:[1,1,1]}},limbs:{body:{size:[8,12,4],texture:[16,16],anchor:[.5,0,.5]},head:{size:[8,8,8],texture:[0,0],anchor:[.5,1,.5],looking:!0},outer:{parent:"head",size:[8,8,8],texture:[32,0],anchor:[.5,.5,.5]},left_arm:{size:[4,12,4],texture:[40,16],anchor:[.5,0,.5],mirror:!0,holding:"left",swiping:!0,swinging:!0},right_arm:{size:[4,12,4],texture:[40,16],anchor:[.5,0,.5],holding:"right",swinging:!0},left_leg:{size:[4,12,4],texture:[0,16],anchor:[.5,0,.5],mirror:!0,swinging:!0},right_leg:{size:[4,12,4],texture:[0,16],anchor:[.5,0,.5],swinging:!0}}}},{}],13:[function(t,e,i){var s=t("../dom"),o=t("../utils"),n=t("../editor"),r=t("./settings"),a=t("./tools"),h=t("./camera"),l=t("./model"),c={67:"scale",76:"picker",77:"move",82:"rotate",84:"translate"},d=e.exports=function(t,e){n.call(this,t,e),this.limb=null,this.actor=t.actor,this.model=new l(t.actor,t.skin),this.settings=new r(this,s.$(".mc-settings",e)),this.toolbar.map={picker:new a.Picker(this),move:new a.Move(this),translate:new a.Translate(this),rotate:new a.Rotate(this),scale:new a.Scale(this)},this.toolbar.set("move")}
...
if(i=i.limb,0==e.indexOf("size")){var r=["w","h","d"],a=r.indexOf(e.substr(o+1))
s.size[a]=parseFloat(t.value),this.editor.model.applyPose(s),this.editor.model.updateAABB(s)}else{var r=["x","y","z"],a=r.indexOf(e.substr(o+1)),h=parseFloat(t.value)
...
o.extend(l,r,{init:function(){r.prototype.init.call(this),s.on(this.file,"change",this.importModel.bind(this)),this.properties.init(),this.poses.init(),this.updateLimbs(),this.fill()},exportAction:function(){var t=this.editor.app.actor.exportJSON()
...
var s=this.poses.current(),o=s.forLimb(i.id)
o.scale[0]=+Math.clamp(this.sx+e,0,1/0).toFixed(1),o.scale[1]=+Math.clamp(this.sy+e,0,1/0).toFixed(1),o.scale[2]=+Math.clamp(this.sz+e,0,1/0).toFixed(1),this.model.applyLimbPose(i,s),this.editor.render(),this.editor.settings.poses.fill()}},onMouseDown:function(t,e){var i=this.editor.limb
if(null!=i){var s=this.poses.current().forLimb(i.limb.id)
...
return 0==t||0==e?alert("You can't use zero as one of canvas' size components ("+t+"x"+e+")"):(this.editor.app.skin.resize(t,e),void this.editor.reset())},importImage:function(){var t=this,e=new FileReader
