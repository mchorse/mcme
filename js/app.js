...
return t.parent||delete t.parent,t.holding||delete t.holding,t.swiping||delete t.swiping,t.looking||delete t.looking,t.swinging||delete t.swinging,t.idle||delete t.idle,t.mirror||delete t.mirror,t},importLimb:function(t){if(0==t.size[0]||0==t.size[1]||0==t.size[2])throw new Exception("Limb '"+t.name+"' has a size of zero ("+t.size.join(", ")+")!")
s.merge(this,t)}}},{"../../utils":39,"./uv":10}],6:[function(t,e,i){var s=t("./poses"),o=t("./limb"),n=e.exports=function(){this.name="",this.limbs=[],this.poses=new s}
...
if(e){e=e.limb
var o=i.split("_")
key=o.shift(),action=key+"Change",this[action]?this[action](e,s,i):e[key]=s}},idChange:function(t,e,i){if(this.editor.app.actor.hasLimb(e)||""==e)return alert('Limb with name "'+e+'" already exist!')
this.editor.app.actor.poses.rename(t.id,e)
for(var s=this.editor.app.actor.limbs,o=0;o<s.length;o++)s[o].parent==t.id&&(s[o].parent=e)
t.id=e,this.updateLimbs(),this.editor.settings.updateLimbs(),this.parent.value=t.parent},parentChange:function(t,e){if(e!=t.id){t.parent=e,t.mesh.parent.remove(t.mesh),(""==e?this.editor.model.group:this.editor.model.get(e)).add(t.mesh)
var i=this.editor.settings.poses.current()
this.editor.model.applyLimbPose(t,i),this.editor.render()}},textureChange:function(t,e,i){var s=["x","y"].indexOf(i.substr(i.indexOf("_")+1))
...
n.prototype.init.call(this),h.renderImage(this).src="assets/img/actor.png",this.picker.init(),this.settings.init(),s.on(s.$(".mc-toggle-settings",this.element),"click",function(){t.settings.toggle()}),this.reset()},clear:function(){this.app.skin.reset(),this.render()},updateTexture:function(){var t=this
clearTimeout(this.timer),this.timer=setTimeout(function(){t.app.model.update()},100)},reset:function(){var t=this.canvas,e=8*this.app.skin.w,i=8*this.app.skin.h
...
o=Color.hsl(o[0],o[1],o[2]).rgbData(),this.fill(i,t,e,o),this.editor.render(),this.editor.updateTexture()}},fill:function(t,e,i,n){function r(e,i){var n=s(e,i,t.w)
...
t.set(i,s,n)})}}},{"../../utils":39}],32:[function(t,e,i){var s=e.exports=function(t){this.pixelData=t.app.skin,this.canvas=t.canvas,this.editor=t}
...
s.prototype={onMouseMove:function(t,e){this.onMouseDown(t,e)},onMouseDown:function(t,e){var i=this.pixelData,s=i.pointToPixel(this.canvas,t,e)
if(t=s.x,e=s.y,!(t<0||t>=i.w||e<0||e>=i.h)){var o=this.picker.primary
i.set(t,e,Color.hsl(o[0],o[1],o[2]).rgbData()),i.renderPixel(this.canvas.getContext("2d"),t,e,s.scale),this.editor.updateTexture()}}}},{}],36:[function(t,e,i){var s=e.exports=function(t){this.editor=t,this.pixelData=t.app.skin,this.canvas=t.canvas}
