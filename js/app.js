...
if(i){i=i.limb
var o=e.split("_")
key=o.shift()+"Change",this[key]?this[key](i,s,e):i[key]=s}},idChange:function(t,i,e){return this.editor.app.actor.hasLimb(i)||""==i?alert('Limb with name "'+i+'" already exist!'):(this.editor.settings.poses.current().rename(t.id,i),t.id=i,this.updateLimbs(),void this.editor.settings.updateLimbs())},parentChange:function(t,i){if(i!=t.id){t.parent=i,t.mesh.parent.remove(t.mesh),(""==i?this.editor.model.group:this.editor.model.get(i)).add(t.mesh)
...
t=t.limb
var i={id:t.id,parent:t.parent,holding:t.holding,looking:t.looking,swiping:t.swiping,swinging:t.swinging,texture_x:t.texture[0],texture_y:t.texture[1],mirror:t.mirror,size_w:t.size[0],size_h:t.size[1],size_d:t.size[2],anchor_x:t.anchor[0],anchor_y:t.anchor[1],anchor_z:t.anchor[2]}
