...
Properties.prototype = 
{
    ...
    {
        this.editor.poses.current().rename(limb.id, value);
        limb.id = value;
        this.updateLimbs();
    ...
    /**
     * Change the role of the limb
     */
    roleChange: function(limb, value)
    {
        limb.role = value;
    },
    ...
    parentChange: function(limb, value)
    {
        ...
        this.editor.poses.current().applyMesh(limb);
    },
    ...
    /**
     * Guess what it does? C'mon, it's really easy. I'll give you 3 tries, ok? 
     * Go!
     */
    toggle: function()
    {
