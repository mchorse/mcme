...
utils.extend(ModelEditor, Editor, 
{
    ...
    {
        var limb = this.app.actor.get(settings.limb);
        
        this.renderer.shadowMap.enabled = settings.shadow;
        this.camera.toggle(!settings.flat);
        this.setLimb(limb ? limb.mesh : null);
    }
});