...
utils.extend(ModelEditor, Editor, 
{
    ...
    /**
     * Setup Axis-Aligned Bounding Box for model. This is useful, because it 
     * shows where the floor going to be, so the model wouldn't float.
     */
    setupAABB: function(scene)
    {
