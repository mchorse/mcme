...
utils.extend(ModelSettings, Settings, 
{
    ...
    resetAction: function()
    {
        ...
        this.editor.app.actor.group.position.set(0, 0, 0);
        this.editor.render();
    },
    ...
    {
        this.editor.app.actor.aabb.visible = input.checked;
        this.editor.render();
    },
    ...
    fill: function()
    {
        dom.$("[name=name]", this.element).value = this.editor.app.actor.name;
