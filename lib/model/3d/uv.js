    ...
    side: function(ww, hh, geo, side, x, y, w, h, reflect)
    {
    	...
    	if (side != 6)
    	{
            if (reflect)
            {
        		...
        		geo.faceVertexUvs[0][side + 1][0].copy(faces[2]);
                geo.faceVertexUvs[0][side + 1][1].copy(faces[3]);
                geo.faceVertexUvs[0][side + 1][2].copy(faces[0]);
            }
            else
            {
        		geo.faceVertexUvs[0][side][0].copy(faces[0]);
                geo.faceVertexUvs[0][side][1].copy(faces[3]);
                geo.faceVertexUvs[0][side][2].copy(faces[1]);
                
        		geo.faceVertexUvs[0][side + 1][0].copy(faces[3]);
                geo.faceVertexUvs[0][side + 1][1].copy(faces[2]);
                geo.faceVertexUvs[0][side + 1][2].copy(faces[1]);
            }
    	}
    	else 
    	{
            if (reflect)
            {
        		geo.faceVertexUvs[0][side][0].copy(faces[2]);
                geo.faceVertexUvs[0][side][1].copy(faces[1]);
                geo.faceVertexUvs[0][side][2].copy(faces[3]);
                
        		geo.faceVertexUvs[0][side + 1][0].copy(faces[1]);
                geo.faceVertexUvs[0][side + 1][1].copy(faces[0]);
                geo.faceVertexUvs[0][side + 1][2].copy(faces[3]);
            }
            else
            {
        		geo.faceVertexUvs[0][side][0].copy(faces[3]);
                geo.faceVertexUvs[0][side][1].copy(faces[0]);
                geo.faceVertexUvs[0][side][2].copy(faces[2]);
                
        		geo.faceVertexUvs[0][side + 1][0].copy(faces[0]);
                geo.faceVertexUvs[0][side + 1][1].copy(faces[1]);
                geo.faceVertexUvs[0][side + 1][2].copy(faces[2]);
            }
    	}
